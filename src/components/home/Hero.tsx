  ...
  return (
    <section className="px-7 pt-19 pb-10">
      <div className="mx-auto grid max-w-[1180px] grid-cols-1 items-center gap-12 lg:grid-cols-[1.1fr_0.9fr]">
        <div>
          <div className="mb-6.5 inline-flex items-center gap-2.5 rounded-full border border-border bg-card py-1.5 pr-3.5 pl-2.5 font-mono text-[12.5px] text-muted-foreground">
